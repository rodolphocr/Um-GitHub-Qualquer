# QUANDO VOCÊ USA UMA CONDIÇÃO COMO IF - ENTÃO - SENÃO, E NA SEQUENCIA FOR USAR UM PRINT(Ex01) PARA MOSTRAR NA TELA VOCÊ VERÁ QUE EXISTIRA 4 ESPAÇOS DO INICIO DO PARAGROFO ATÉ A PRIMEIRA LETRA DE 'PRINT', ISSO QUER DIZER QUE TUDO QUE ESTIVER COM ESSES 4 ESPAÇOS EMBAIXO DO IF, PERTENCE A ESSE COMANDO. E ASSIM PARA O ELIF E ELSE.
